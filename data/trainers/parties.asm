...
WhitneyGroup:
	...
	db 20, TAUROS,     HEADBUTT, THUNDERBOLT, IRON_TAIL, REST
...
PryceGroup:
	...
	db 40, JYNX,       MEAN_LOOK, ICE_BEAM, LOVELY_KISS, PSYCHIC_M
	db 40, CLOYSTER,   SPIKES, TOXIC, SURF, CLAMP
	db 41, DEWGONG,    BLIZZARD, DISABLE, HYPER_BEAM, REST
	db -1 ; end
...
ClairGroup:
	...
	db 45, DRAGONAIR,  THUNDER_WAVE, SURF, LIGHT_SCREEN, RAIN_DANCE
	db 45, DRAGONAIR,  THUNDER_WAVE, THUNDER, SUPERSONIC, RAIN_DANCE
	db 45, GYARADOS,   HYDRO_PUMP, ICE_BEAM, FIRE_BLAST, ROAR
	db 46, KINGDRA,    HYDRO_PUMP, DOUBLE_EDGE, HYPER_BEAM, CURSE
	db -1 ; end
...
KogaGroup:
	...
	db 49, MUK,        GIGA_DRAIN, ACID_ARMOR, SLUDGE_BOMB, REST
...
BirdKeeperGroup:
	...
	db  8, PIDGEY,    GUST, SAND_ATTACK, MUD_SLAP, SWIFT    
	db  8, SPEAROW,   PECK, LEER, QUICK_ATTACK, GROWL

	; BIRD_KEEPER (2)
	db "ABE@", TRAINERTYPE_MOVES
	db  9, MURKROW,   PECK, PURSUIT, DOUBLE_TEAM, TOXIC 
	db -1 ; end

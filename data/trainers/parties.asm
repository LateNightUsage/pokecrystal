...
FalknerGroup:
	...
	db  10, PIDGEOTTO,   QUICK_ATTACK, GUST, WHIRLWIND, MUD_SLAP
	db  11, NOCTOWL,    PECK, CURSE, SUPERSONIC, HYPNOSIS

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 20, CLEFABLE,   RETURN, FLAMETHROWER, DEFENSE_CURL, MOONLIGHT
	db 20, MILTANK,    ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db 21, TAUROS,     HEADBUTT, THUNDERBOLT, IRON_TAIL, REST
	db -1 ; end

BugsyGroup:
	; BUGSY (1)
	db "BUGSY@", TRAINERTYPE_MOVES
	db 15, BEEDRILL,    FURY_ATTACK, FOCUS_ENERGY, SLUDGE_BOMB, NO_MOVE
	db 15, SCYTHER,     QUICK_ATTACK, LIGHT_SCREEN, SWORDS_DANCE, BATON_PASS
	db 16, HERACROSS,    HORN_ATTACK, LEER, COUNTER, DETECT
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_MOVES
	db 25, GASTLY,     DESTINY_BOND, CONFUSE_RAY, SHADOW_BALL, CURSE
	db 25, GENGAR,     HYPNOSIS, SHADOW_BALL, THUNDER, DREAM_EATER
	db 26, MISDREAVUS, PAIN_SPLIT, TOXIC, PROTECT, PSYCHIC_M
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 35, JYNX,       MEAN_LOOK, ICE_BEAM, LOVELY_KISS, PSYCHIC_M
	db 35, CLOYSTER,   SPIKES, TOXIC, SURF, CLAMP
	db 36, DEWGONG,    BLIZZARD, DISABLE, HYPER_BEAM, REST
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_MOVES
	db 35, MAGNETON,   THUNDER, SUPERSONIC, RAIN_DANCE, THUNDER_WAVE
	db 35, STEELIX,    SCREECH, SANDSTORM, DIG, IRON_TAIL
	db 36, SKARMORY,   STEEL_WING, TOXIC, SAND_ATTACK, DRILL_PECK
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_MOVES
	db 30, TYROGUE,    CURSE, MACH_PUNCH, DIZZY_PUNCH, DOUBLE_TEAM
	db 30, POLIWRATH,  HYPNOSIS, ICE_PUNCH, SURF, DYNAMICPUNCH
	db 31, MACHAMP,    CROSS_CHOP, FIRE_PUNCH, REST, SLEEP_TALK 
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 40, DRAGONAIR,  THUNDER_WAVE, SURF, LIGHT_SCREEN, RAIN_DANCE
	db 40, DRAGONAIR,  THUNDER_WAVE, THUNDER, SUPERSONIC, RAIN_DANCE
	db 40, GYARADOS,   HYDRO_PUMP, ICE_BEAM, FIRE_BLAST, ROAR
	db 41, KINGDRA,    HYDRO_PUMP, DOUBLE_EDGE, HYPER_BEAM, CURSE
	db -1 ; end
...
WillGroup:
	...
	db 46, XATU,       NIGHT_SHADE, DRILL_PECK, CONFUSE_RAY, PSYCHIC_M
	db 46, JYNX,       ICE_BEAM, LOVELY_KISS, SUBSTITUTE, PSYCHIC_M
	db 46, EXEGGUTOR,  LEECH_SEED, STUN_SPORE, GIGA_DRAIN, PSYCHIC_M
	db 46, SLOWBRO,    PSYCHIC_M, SURF, REST, SLEEP_TALK
	db 47, ESPEON,     PSYCHIC_M, MORNING_SUN, GROWTH, BITE
	db -1 ; end
...
BrunoGroup:
	...
	db 47, HITMONLEE, HI_JUMP_KICK, MEDITATE, DOUBLE_TEAM, PROTECT
	db 47, CLOYSTER,  SURF, ICE_BEAM, EXPLOSION, HYPER_BEAM
	db 47, GOLEM,     EARTHQUAKE, ROCK_SLIDE, EXPLOSION, CURSE
	db 47, STEELIX,   EARTHQUAKE, CURSE, ROAR, HYPER_BEAM
	db 48, MACHAMP,   CROSS_CHOP, ROCK_SLIDE, EARTHQUAKE, FIRE_BLAST
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_MOVES
	db 48, UMBREON,    CHARM, PURSUIT, ZAP_CANNON, REST
	db 48, VILEPLUME,  STUN_SPORE, SWORDS_DANCE, MOONLIGHT, SLUDGE_BOMB 
	db 48, GENGAR,     THUNDER, ICE_PUNCH, DYNAMICPUNCH, DESTINY_BOND
	db 48, MURKROW,    SKY_ATTACK, NIGHT_SHADE, PURSUIT, FAINT_ATTACK
	db 49, HOUNDOOM,   COUNTER, PURSUIT, FIREBLAST, CRUNCH
	db -1 ; end

KogaGroup:
	; KOGA (1)
	db "KOGA@", TRAINERTYPE_MOVES
	db 49, SCIZOR,     SWORDS_DANCE, AGILITY, BATON_PASS, STEEL_WING
	db 49, VENOMOTH,   SLUDGE_BOMB, BATON_PASS, PSYCHIC_M, CURSE
	db 49, NINETALES,  ROAR, FIRE_BLAST, CONFUSE_RAY, TOXIC
	db 49, MUK,        GIGA_DRAIN, ACID_ARMOR, SLUDGE_BOMB, EXPLOSION
	db 50, CROBAT,     CONFUSE_RAY, MEAN_LOOK, WING_ATTACK, TOXIC
	db -1 ; end

ChampionGroup:
	; CHAMPION (1)
	db "LANCE@", TRAINERTYPE_MOVES
	db 50, AERODACTYL, WING_ATTACK, ANCIENTPOWER, EARTHQUAKE, FIRE_BLAST
	db 50, GYARADOS,   DOUBLE_EDGE, ZAP_CANNON, HYDRO_PUMP, HYPER_BEAM
	db 50, TYRANITAR,  DYNAMICPUNCH, PURSUIT, ROCK_SLIDE, HYPER_BEAM
	db 50, DRAGONITE,  REFLECT, LIGHT_SCREEN, BODY_SLAM, REST
	db 50, DRAGONITE,  DYNAMICPUNCH, THUNDER, ICE_BEAM, THUNDER_WAVE
	db 51, CHARIZARD,  FIRE_BLAST, ROCK_SLIDE, BELLY_DRUM, HYPER_BEAM
	db -1 ; end
...
BirdKeeperGroup:
	...
	db  10, PIDGEY,    GUST, SAND_ATTACK, MUD_SLAP, SWIFT    
	db  10, SPEAROW,   PECK, LEER, QUICK_ATTACK, GROWL

	; BIRD_KEEPER (2)
	db "ABE@", TRAINERTYPE_MOVES
	db  10, MURKROW,   PECK, PURSUIT, DOUBLE_TEAM, TOXIC 
	db -1 ; end
...
RedGroup:
	...
	db 81, PIKACHU,  LIGHT_BALL,   SING, SURF, THUNDER_WAVE, THUNDER
